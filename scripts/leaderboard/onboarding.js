      ...
      if (result.success) {
        ...
        if (result.logout) {
          window.location.href =
            '/leaderboard/logout.html?message=' +
            encodeURIComponent(
              "The server wasn't able to verify your Discord account. Please sign in again via Discord or contact a club officer for assistance.",
            );
        }
